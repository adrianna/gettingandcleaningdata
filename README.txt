...
2. Read in Files
        ...
        c. activity_labels.txt - labels for activities. These string names will substitute the numeric
           value given in both test_Y and train_Y. There are six numeric values for activities, which
           translate to WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING
